...
type UserModel struct {
	...
	// @inject_tag: json:"create_uid"
	CreateUid uint32 `protobuf:"varint,11,opt,name=CreateUid,proto3" json:"create_uid"`
}
...
func (x *UserModel) GetUid() uint64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
func (x *UserModel) GetDesc() string {
	if x != nil {
		return x.Desc
	}
	return ""
...
func (x *UserModel) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *UserModel) GetCreateUid() uint32 {
	if x != nil {
		return x.CreateUid
	}
	return 0
...
var file_userModels_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x08, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x22, 0x9d, 0x02, 0x0a,
	0x09, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x49, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x55, 0x69,
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x55, 0x69, 0x64, 0x12, 0x1a, 0x0a, 0x08,
	...
	0x07, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x44, 0x65, 0x73, 0x63,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x44, 0x65, 0x73, 0x63, 0x12, 0x16, 0x0a, 0x06,
	...
	0x01, 0x28, 0x03, 0x52, 0x09, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x1c,
	0x0a, 0x09, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x09, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x69, 0x64, 0x42, 0x0b, 0x5a, 0x09,
